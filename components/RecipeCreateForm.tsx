...
function SubmitButton({ finished }: { finished: boolean }) {
	// LEVEL 2: Step 9: Dohvatiti pending status forme
	const { pending } = useFormStatus();

	// LEVEL 2: Step 10: Dodati Loader2 komponentu i disableat Button dok se form data šalje
	return (
		...
		<form className='max-w-sm flex flex-col gap-3' action={formAction}>
			...
			<div className='space-y-1'>
				...
				<Textarea
					id='description'
					name='description'
					placeholder='This is a delicious meal from my grandma.'
				/>
			</div>
			<div className='space-y-1'>
			...
			<div className='space-y-1'>
				...
				<Textarea
					id='methods'
					name='methods'
					placeholder='Cook for 30 minutes, bake for 1 hour, let it cool down for 10 minutes.'
				/>
			</div>
			<div className='space-y-1'>
				...
				<p className='text-muted-foreground text-sm'>
					You can add multiple images for your meal/dessert, but only{' '}
					<b>.jpg</b>, <b>.jpeg</b>, <b>.png</b> or <b>.webp</b> files.
				</p>
			</div>
			...
			{/* LEVEL 2: Step 11: Dodati SubmitButton komponentu */}
